  ...
  return (
    <div>
      <ScreenHeader
        title="Today"
        right={
          <button aria-label="Settings" className="p-2 text-ink-3">
      ...
      />
      <Card kicker="Should I train?" title="Readiness">
        <p className="py-6 text-center text-[14px] text-ink-3">
          Connects after account setup — readiness ring, verdict and factor breakdown land here.
        </p>
      </Card>
    </div>
  );
